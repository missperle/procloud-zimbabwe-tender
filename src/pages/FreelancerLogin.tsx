...
const FreelancerLogin = () => {
  ...
  if (currentUser) {
    // First try to navigate based on role, fall back to freelancer dashboard
    (async () => {
      ...
      try {
        ...
        if (data?.role === "client") {
          toast({
            title: "Role mismatch",
            description: "You're logging in with a client account. Redirecting to client dashboard.",
          });
        ...
        // Fall back to freelancer dashboard on error
        navigate("/freelancer-dashboard", { replace: true });
      } finally {
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4 client-dashboard">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Access your freelancer dashboard to find work and manage projects
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-4">
            <Link to="/client-login" className="text-sm text-accent hover:underline">
