...
const FreelancerDashboard = () => {
  ...
  useEffect(() => {
    const loadFreelancerData = async () => {
      ...
      try {
        console.log("FreelancerDashboard: Fetching data for:", currentUser.id);
        ...
        if (userError) {
          console.error("FreelancerDashboard: Error fetching user data:", userError);
        } else if (userData) {
        ...
        console.error("FreelancerDashboard: Error loading data:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <RoleGuard allowedRoles={["freelancer"]} redirectTo="/freelancer-login">
      <Layout>
        <div className="container mx-auto px-4 py-8">
